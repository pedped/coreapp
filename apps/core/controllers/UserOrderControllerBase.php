    ...
    public function listAction($page = 1) {
        ...
        $paginator->
                setTableHeaders(array(
                    'ID', 'User ID', 'Type', 'Item ID', 'Payment Product Type', 'Payment Item ID', 'price', 'Price Currency', 'date'
                ))->
                setFields(array(
                    'id', 'userid', 'type', 'itemid', 'paymenttype', 'paymentitemid', 'price', 'pricecurrency', 'date'
                ))->
                setEditUrl(
                        'edit'
                )->
